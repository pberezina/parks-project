...
```{r convert to pdf, include=FALSE, echo=FALSE, warning=FALSE}
library(xaringanBuilder)
xaringanBuilder::build_pdf("C:/Users/tang53/Documents/1Course/STAT6730-Comp stat/FINAL/slides_v2.html", complex_slides = TRUE, partial_slides = TRUE)
```
